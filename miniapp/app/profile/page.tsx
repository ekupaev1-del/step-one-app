  ...
  return (
    <AppLayout>
      ...
      <div className="max-w-md mx-auto">
        ...
        <div className="bg-orange-500 rounded-2xl shadow-soft p-6 mb-4">
          <button
          ...
          {normsExpanded && (
            <div className="mt-4 space-y-3 animate-fadeIn">
              {profile.caloriesGoal && (
                <div className="flex justify-between items-center py-2 border-b border-orange-400/50">
              ...
              {profile.waterGoalMl && (
                <div className="flex justify-between items-center py-2">
                  <span className="text-white/90">Вода</span>
