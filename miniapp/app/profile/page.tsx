  ...
  return (
    <AppLayout>
      ...
      <div className="max-w-md mx-auto">
        ...
        <div className="bg-purple-600 rounded-2xl shadow-soft p-6 mb-4">
          <button
            ...
            <div className="mt-4 space-y-3 animate-fadeIn">
              {profile.caloriesGoal && (
                <div className="flex justify-between items-center py-2 border-b border-purple-400/30">
                  <span className="text-purple-100">Калории</span>
              ...
              {profile.proteinGoal && (
                <div className="flex justify-between items-center py-2 border-b border-purple-400/30">
                  <span className="text-purple-100">Белки</span>
              ...
              {profile.fatGoal && (
                <div className="flex justify-between items-center py-2 border-b border-purple-400/30">
                  <span className="text-purple-100">Жиры</span>
              ...
              {profile.carbsGoal && (
                <div className="flex justify-between items-center py-2 border-b border-purple-400/30">
                  <span className="text-purple-100">Углеводы</span>
              ...
              {profile.waterGoalMl && (
                <div className="flex justify-between items-center py-2">
                  <span className="text-purple-100">Вода</span>
