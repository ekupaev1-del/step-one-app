-- ============================================================================
-- FULL DATABASE RESET - Run this in Supabase SQL Editor
-- ============================================================================
-- This script recreates the entire database schema from scratch.
-- WARNING: This will DROP all existing tables and data!
-- Only use this for a fresh Supabase project or when you need to reset everything.
-- ============================================================================

-- Drop all existing tables (in reverse dependency order)
DROP TABLE IF EXISTS robokassa_invoices CASCADE;
...
-- Note: Policies will be dropped automatically when tables are dropped
-- They will be recreated later in the script
